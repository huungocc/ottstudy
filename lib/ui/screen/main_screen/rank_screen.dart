...
class _RankBodyState extends State<RankBody> {
  ...
  Widget build(BuildContext context) {
    return BaseScreen(
      ...
      messageNotify: CustomSnackBar<RankCubit>(),
      title: const Align(
        ...
        children: [
          ...
          BlocBuilder<MyRankCubit, BaseState>(
            builder: (context, state) {
              ...
              return const Center(
                child: CustomTextLabel('Bạn chưa có dữ liệu xếp hạng!', fontStyle: FontStyle.italic, fontSize:
                12, color: AppColors.gray_title,),
              );
            },
          ),
          const SizedBox(height: 20),
